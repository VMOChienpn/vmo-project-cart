...
const Header = () => {
    return (
        <div >
            <header className=" fixed w-full items-center hidden sm:flex p-3 bg-gray-300">
                <div className="w-1/2" />
                    <div className="relative w-1/2 flex justify-end">
                        <button  className="realtive z-10 w-12 h-12 rounded-full overflow-hidden border-4 border-gray-400 hover:border-gray-500 focus:border-gray-300 focus:outline-none">
