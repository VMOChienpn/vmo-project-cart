...
const Food = () => {
    ...
    const DeleteBtn = (e) => {
        e.preventDefault()
        dispatch(deleteProductAdmin("foods", idDelete))
        setisFormDelete(!isFormDelete)
    ...
    return (
        <div className="h-auto" >
            ...
            <h1 className="text-2xl font-bold text-center mt-10 mb-1">FOOD</h1>
            ...
            <div className="w-full">
                <div className="bg-white w-full mr-7 relative" style={{height:"580px"}}>
                    <table className="min-w-full bg-white ">
                        <thead className="bg-gray-500 text-white">
                            <tr>
                                ...
                                <th className="w-5/12 text-left py-3 px-4 uppercase font-semibold text-sm">Description</th>
        ...
        <ToastContainer/>
        <Pagination totalDrink={food.length} postsPerPage={postsPerPage} paginate={paginate}/>
        </div>
